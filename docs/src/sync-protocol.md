...
The GetLatestVersionId transaction returns the ID of the current, latest version.
The request contains no information.
If there are no versions at all, the server returns the nil UUID as the latest version.
